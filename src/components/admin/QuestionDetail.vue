  ...
  <div class="question-detail">
    <header>
      ...
      <div class="function">
        ...
        <!-- 点赞 -->
        <div class="like">
          <span><svg t="1679058778119" class="icon" viewBox="0 0 1024 1024" version="1.1"
                     xmlns="http://www.w3.org/2000/svg" p-id="2802" width="18" height="18"><path
              ...
              :fill="color" p-id="2803"></path></svg></span>
          <span class="num">{{ questionData.likeCount }}</span>
        </div>
        <!-- 收藏 -->
        <div class="select">
